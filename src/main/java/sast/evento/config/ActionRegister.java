...
public class ActionRegister implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private String host = "sast.evento";
    ...
    private void parseAll(Set<Class> set) {
        for (Class c : set) {
            ...
            for (Method m : declaredMethods) {
                ...
                actionName2action.put(methodName,new Action(description,methodName,r.method()[0].name(),String.valueOf(url),defaultIsVisible,defaultIsPublic));
            }
        }
    }
